...
### Changed
- **Startscreen-Motive als Minimal-Premium-Icons:** Die vier Hauptkarten (`Multiplayer`, `Einzelspiel`, `Statistik`, `Einstellungen`) nutzen ruhigere inline-SVG-Motive mit grossen klaren Formen, wenigen Linien und DiceBudget-Farben statt detailreicher Szenen. Die Motive bleiben per Max-Hoehen und Small-Viewport-Regeln im Gesamtbild der Kacheln. Dateien: `frontend/components/HomeBentoGrid.tsx`, `frontend/app/globals.css`
