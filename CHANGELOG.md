...
### Fixed
- **Yatzy-Strichliste am Würfel:** Markierung neben der Augenzahl ist schwarz, so hoch wie der Würfel (statt kleiner gelber Textstriche); etwas Abstand links für den Würfel. Dateien: `ScoreSheetTable.tsx`, `globals.css`
